...
void __fastcall TfrmHydroGraph::HydroGraph(int iGraph)
{
        int i,j; //i:col,j:row
        ...
        switch(iGraph)
        {
         ...
         case 1:
                ...
                for(j=1;j<StringGrid1->RowCount;j++)
                {
                        Series_R->AddXY(StringGrid1->Cells[0][j].ToInt(),StringGrid1->Cells[iRunoff][j].ToDouble(),"",clRed);
                        Series_ETa->AddXY(StringGrid1->Cells[0][j].ToInt(),StringGrid1->Cells[iETa][j].ToDouble(),"",clGreen);
                        Series_Rd->AddXY(StringGrid1->Cells[0][j].ToInt(),StringGrid1->Cells[iSurfaceRunoff][j].ToDouble(),"",clBlue);
                        Series_Rs->AddXY(StringGrid1->Cells[0][j].ToInt(),StringGrid1->Cells[iSubsurfaceRunoff][j].ToDouble(),"",clBlack);
                }
